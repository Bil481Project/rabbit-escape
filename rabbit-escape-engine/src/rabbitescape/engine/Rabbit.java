...
public class Rabbit extends Thing implements Comparable<Rabbit>
{
    ...
    //private Falling fallingAfterJumping;
    ...
    private void createBehaviours(){
        ...
        falling = new Falling( climbing, brollychuting,jumping );
        //fallingAfterJumping = new Falling( jumping, brollychuting );
        ...
        //behavioursTriggerOrder.add( fallingAfterJumping );
        ...
        //behaviours.add( fallingAfterJumping );
   ...
   /* public boolean isFallingAfterJumpingToDeath()
    {
        return fallingAfterJumping.isFallingToDeath();
    }*/

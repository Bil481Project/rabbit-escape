...
public class Token extends Thing
{
    ...
    public static enum Type
    {
        ...
        explode,
        brolly,
        jump//ziplama yetenegi eklemek icin
    }
    ...
    private static State switchType( Type type, boolean moving, boolean slopeBelow, boolean onSlope )
    {
        switch( type )
        {
            ...
            case jump: return chooseState(moving, slopeBelow, onSlope,
                TOKEN_JUMPING_FALLING,TOKEN_JUMPING_STILL,
                TOKEN_JUMPING_FALL_TO_SLOPE,TOKEN_JUMPING_ON_SLOPE);
            //ziplama durumunu eklemek icin
    ...
    public void step( World world )
    {
        ...
        case TOKEN_JUMPING_FALL_TO_SLOPE:
        case TOKEN_JUMPING_FALLING:
        {
            ++y;
